...
def fullz_autoshop(update: Update, context: CallbackContext) -> int:
...
def digital_docs(update: Update, context: CallbackContext) -> int:
...
def main() -> None:
    ...
    conversation_handler = ConversationHandler(
        ...
        states={
            MENU: [MessageHandler(Filters.regex('^(Fullz Autoshop|Balance|Digital Docs & Ids|F.A.Q)$'), fullz_autoshop)],
